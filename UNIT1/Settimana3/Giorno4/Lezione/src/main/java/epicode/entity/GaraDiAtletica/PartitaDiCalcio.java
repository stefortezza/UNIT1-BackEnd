...
@Entity
public class PartitaDiCalcio extends GestioneEventi {
    ...
    public PartitaDiCalcio(int id, String titolo, LocalDate dataEvento, String descrizione, TipoEvento tipoEvento, int numeroMassimoPartecipanti, String squadraCasa, String squadraOspite, String squadraVincente, int goalCasa, int goalOspite) {
